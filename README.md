...
### Featured Projects  
- **RFM Analysis Using Python**: Creating actionable customer segmentation for marketing strategies.  
- **Advanced Stock Prediction Using LSTM**: Employing attention mechanisms for precise financial forecasting.  
- **Mental Health Analysis Using SQL**: Exploring social impact through data-driven insights.  

---

## Connect & Collaborate
📫 **LinkedIn**: [Adan Uraga](https://www.linkedin.com/in/adan-uraga/)  
📧 **Email**: [adanuraga@gmail.com](mailto:adanuraga@gmail.com)  
